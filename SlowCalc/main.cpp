/*
   SlowCalc: a slow decimal, floating-point calculator for 8 to 256 digits
      of DECIMAL precision, with an exponent range of +- one billion.
      MODE_1: 50 digits of precision fixed, range +- 99.
      MODE_2: 70 digits of precision fixed, range +- 999.
...
int main (void)
 {
   ...
   std::cerr << "Reverse Polish Notation calculator, version 2." << std::endl
      << "Programmed by Thomas DiModica." << std::endl
      << "Type 'help' for help, 'print' to see the top item on the stack,"
