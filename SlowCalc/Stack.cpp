...
==============================================================================
*/
   Stack::Stack () : myMode(Round::ROUND_TO_NEAREST_TIES_TO_EVEN) { }
...
==============================================================================
*/
   void Stack::focus (void) { Rounder::setGlobalRoundMode(myMode); }
...
==============================================================================
*/
   Round::RoundMode Stack::getRoundMode (void) { return myMode; }
...
==============================================================================
*/
   Round::RoundMode Stack::setRoundMode (Round::RoundMode toThis)
